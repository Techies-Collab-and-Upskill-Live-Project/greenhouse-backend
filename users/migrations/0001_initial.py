    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retype_password', models.CharField(default='re_enter password', max_length=8)),
                ('user_type', models.CharField(choices=[('Customer', 'Customer'), ('Admin', 'Admin'), ('Vendor', 'Vendor')], default='Customer', max_length=50)),
